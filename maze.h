...
* EECE 287
* 05/04/2016
* Description: This file declares function to be used to guide the Rover 5 
* Through a line-maze.
*/
...
#define LEFT_DRIFT 			((WHITE & 0xF8) | (BLACK & 0x07)) // WWWW WBBB
...
#define ALMOST_ALL_WHITE 	((WHITE & 0xFE) | (BLACK & 0x01)) // WWWW WWWB
#define ALL_WHITE 			(WHITE)							  // WWWW WWWW
#define ALL_BLACK 			(BLACK)							  // BBBB BBBB

// navigateMaze() utilizes the functions in motor.h and qtr_driver.h to drive 
// through the maze using a right-hand search.
void navigateMaze();
